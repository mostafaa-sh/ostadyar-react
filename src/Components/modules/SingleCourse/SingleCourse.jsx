...
import CircleSpinner from "../../modules/CircleSpinner/CircleSpinner";
function SingleCourse({ bootstrapClass }) {
  const [isShowImage, setIsShowImaeg] = useState(false);
  const onImageLoaded = () => {
    setIsShowImaeg(true);
  };
  return (
    <div className={bootstrapClass ? "col-4" : ""}>
